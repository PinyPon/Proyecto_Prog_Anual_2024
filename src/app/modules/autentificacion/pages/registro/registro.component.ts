...
// Estos servicios se hacen accesibles en la clase a través de las variables públicas correspondientes.
  ...
  async registrar(){
    ...
    //await: Espera a que el servicio de autenticación termine de registrar al usuario antes de continuar.
  ...
  /* Función que accede a servicio FIRESTORE y envía la información 
    agrega junto al UID
  */
   // guardarUsuario: Usa el servicio de Firestore para agregar el usuario a la base de datos 
  // y maneja los resultados.
  ...
  limpiarInputs(){
    ...
    */
    ...
    // limpiarInputs: Reinicia todos los campos del formulario a valores vacíos.
  }
}
